...
public:
    enum Bound{NO, GB, PGB, DGB, RPB, RRPB, GB_LINEAR, GB_SEMIDEF, PGB_SEMIDEF, RRPB_PGB, DGB_SEMIDEF, DGB_LINEAR};
    ...
    virtual double error(const set<size_t> &indexSet) const=0;
